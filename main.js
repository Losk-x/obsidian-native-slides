...
`;
  ...
  sampleStyles() {
    ...
    const topChain = (() => {
      const cc = contentEl.querySelector(".cm-content");
      if (!cc) return void 0;
      const parts = [];
      let node = cc;
      while (node && node !== contentEl && node !== document.body) {
    ...
    const dump = {
      ...
      h1TopInContent,
      cmContentChildren,
      topChain: isEdit ? topChain : void 0,
