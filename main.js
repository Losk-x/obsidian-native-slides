...
var NativeSlidesPlugin = class extends import_obsidian5.Plugin {
  ...
  updateInlineTitle(slides) {
    ...
    const existing = content.querySelector(":scope > .native-slides-title");
    if (text) {
      let el = existing;
      if (!el) {
