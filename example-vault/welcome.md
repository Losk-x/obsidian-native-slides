...
- Reading view auto-enters fullscreen mode: sidebars, tab bar and header bar are hidden

Press `Cmd/Ctrl + Shift + →` for the next page; `Esc` exits fullscreen **and** leaves reading view.
